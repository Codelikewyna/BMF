...
const RSS_URL = `https://api.allorigins.win/get?url=${encodeURIComponent('https://www.blogger.com/feeds/3783475574659970910/posts/default?alt=json')}`;
...
async function loadBlogPosts() {
  try {
    ...
    // Loop through posts and display them (limit to 5 posts)
